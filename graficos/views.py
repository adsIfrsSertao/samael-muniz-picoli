...
def gerar_grafico(request):
    ...
    if form.is_valid():
        ...
        if vendedor and not cliente and not ano:
            resultados = (
                vendas
                .values('data_da_venda__year')
                .annotate(total=Sum('valor_total') if tipo_grafico == 'valor' else Sum('quantidade'))
            ...
            resultados = (
                vendas
                .values('data_da_venda__year', 'produto__produto')
                .annotate(total=Sum('quantidade') if tipo_grafico == 'quantidade' else Sum('valor_total'))
                .order_by('-total')
            )
