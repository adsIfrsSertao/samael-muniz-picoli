...
class Venda(models.Model):
    ...
    valor_unitario = models.DecimalField('Valor Unitário', max_digits=11, decimal_places=2)
    valor_total = models.DecimalField('Valor Total', max_digits=11, decimal_places=2)
