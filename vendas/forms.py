...
class VendaForm(forms.ModelForm):
    ...
    def clean_quantidade(self):
        ...
        Verifica se a quantidade informada é pelo menos 1. Se a quantidade
        for menor que 1, uma ValidationError é levantada com uma
        mensagem apropriada.
    ...
    def clean_valor_unitario(self):
        ...
        Verifica se o valor unitário informado é pelo menos 0.1.
        Se o valor unitário for menor que 0.1, uma ValidationError é
        levantada com uma mensagem apropriada.
    ...
    def clean_valor_total(self):
        ...
        for menor que 0.1, uma ValidationError é levantada com
